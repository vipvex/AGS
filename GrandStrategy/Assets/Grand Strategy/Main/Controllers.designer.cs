...
// ------------------------------------------------------------------------------
    ...
    public class PlayerControllerBase : uFrame.MVVM.Controller {
        ...
        public virtual void InitializePlayer(PlayerViewModel viewModel) {
            ...
            viewModel.SetMousePosHoverHex.Action = this.SetMousePosHoverHexHandler;
        ...
        public virtual void SetMousePosHoverHexHandler(SetMousePosHoverHexCommand command) {
            this.SetMousePosHoverHex(command.Sender as PlayerViewModel, command.Argument);
        }
        
        public virtual void SetMousePosHoverHex(PlayerViewModel viewModel, Vector3 arg) {
        }
    }
    ...
    public class FogOfWarControllerBase : uFrame.MVVM.Controller {
        
        private uFrame.MVVM.IViewModelManager _FogOfWarViewModelManager;
        ...
        [uFrame.IOC.InjectAttribute("FogOfWar")]
        public uFrame.MVVM.IViewModelManager FogOfWarViewModelManager {
            get {
                return _FogOfWarViewModelManager;
            }
            set {
                _FogOfWarViewModelManager = value;
            }
        }
        ...
        public IEnumerable<FogOfWarViewModel> FogOfWarViewModels {
            get {
                return FogOfWarViewModelManager.OfType<FogOfWarViewModel>();
            }
        }
        ...
        public virtual FogOfWarViewModel CreateFogOfWar() {
            return ((FogOfWarViewModel)(this.Create(Guid.NewGuid().ToString())));
        }
        
        public override uFrame.MVVM.ViewModel CreateEmpty() {
            return new FogOfWarViewModel(this.EventAggregator);
        }
        
        public virtual void InitializeFogOfWar(FogOfWarViewModel viewModel) {
            // This is called when a FogOfWarViewModel is created
            FogOfWarViewModelManager.Add(viewModel);
        }
        
        public override void DisposingViewModel(uFrame.MVVM.ViewModel viewModel) {
            base.DisposingViewModel(viewModel);
            FogOfWarViewModelManager.Remove(viewModel);
        }
    }
    
    public class MainMenuControllerBase : uFrame.MVVM.Controller {
        
        private uFrame.MVVM.IViewModelManager _MainMenuViewModelManager;
        ...
        public uFrame.MVVM.IViewModelManager MainMenuViewModelManager {
            get {
