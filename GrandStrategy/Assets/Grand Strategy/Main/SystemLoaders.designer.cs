...
// ------------------------------------------------------------------------------
    ...
    public class WorldGenerationLoaderBase : uFrame.Kernel.SystemLoader {
        ...
        public virtual FogOfWarController FogOfWarController {
            get {
                if (_FogOfWarController==null) {
                    _FogOfWarController = Container.CreateInstance(typeof(FogOfWarController)) as FogOfWarController;;
                }
                return _FogOfWarController;
            }
            set {
        ...
        public override void Load() {
            ...
            Container.RegisterViewModelManager<FogOfWarViewModel>(new ViewModelManager<FogOfWarViewModel>());
    ...
    public class MenuLoaderBase : uFrame.Kernel.SystemLoader {
