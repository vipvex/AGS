...
// ------------------------------------------------------------------------------
    ...
    public partial class PlayerViewModelBase : uFrame.MVVM.ViewModel {
        ...
        private P<Hex> _HoverHexProperty;
        
        private Signal<SetMousePosHoverHexCommand> _SetMousePosHoverHex;
        
        public PlayerViewModelBase(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
        
        public virtual P<Hex> HoverHexProperty {
            get {
                return _HoverHexProperty;
            }
            set {
                _HoverHexProperty = value;
            }
        }
        
        public virtual Hex HoverHex {
            get {
                return HoverHexProperty.Value;
            }
            set {
                HoverHexProperty.Value = value;
            }
        }
        
        public virtual Signal<SetMousePosHoverHexCommand> SetMousePosHoverHex {
            get {
                return _SetMousePosHoverHex;
            }
            set {
                _SetMousePosHoverHex = value;
            }
        }
        
        public override void Bind() {
            base.Bind();
            this.SetMousePosHoverHex = new Signal<SetMousePosHoverHexCommand>(this);
            _HoverHexProperty = new P<Hex>(this, "HoverHex");
        }
        ...
        protected override void FillCommands(System.Collections.Generic.List<uFrame.MVVM.ViewModelCommandInfo> list) {
            base.FillCommands(list);
            list.Add(new ViewModelCommandInfo("SetMousePosHoverHex", SetMousePosHoverHex) { ParameterType = typeof(Vector3) });
        }
        
        protected override void FillProperties(System.Collections.Generic.List<uFrame.MVVM.ViewModelPropertyInfo> list) {
            base.FillProperties(list);
            // PropertiesChildItem
            list.Add(new ViewModelPropertyInfo(_HoverHexProperty, false, false, false, false));
        }
    }
    ...
    public partial class FogOfWarViewModelBase : uFrame.MVVM.ViewModel {
        
        public FogOfWarViewModelBase(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    ...
    public partial class FogOfWarViewModel {
        ...
        public FogOfWarViewModel(uFrame.Kernel.IEventAggregator aggregator) : 
                base(aggregator) {
        }
    }
    
    public partial class MainMenuViewModelBase : uFrame.MVVM.ViewModel {
