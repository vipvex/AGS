...
// ------------------------------------------------------------------------------
    ...
    public class ChunkManagerViewBase : uFrame.MVVM.ViewBase {
        ...
        [UnityEngine.SerializeField()]
        private ChunkTreesManagerView _ChunkTreesManagerView;
        
        [UnityEngine.SerializeField()]
        private ChunksFogOfWarView _ChunksFogOfWarView;
        ...
        public virtual ChunkTreesManagerView ChunkTreesManagerView {
            get {
                return _ChunkTreesManagerView ?? (_ChunkTreesManagerView = this.gameObject.EnsureComponent<ChunkTreesManagerView>());
            }
        }
        
        public virtual ChunksFogOfWarView ChunksFogOfWarView {
            get {
                return _ChunksFogOfWarView ?? (_ChunksFogOfWarView = this.gameObject.EnsureComponent<ChunksFogOfWarView>());
            }
        }
    ...
    public class PlayerUIBase : uFrame.MVVM.ViewBase {
        ...
        [UFGroup("View Model Properties")]
        [UnityEngine.HideInInspector()]
        public Hex _HoverHex;
        
        [UFToggleGroup("HoverHex")]
        [UnityEngine.HideInInspector()]
        public bool _BindHoverHex = true;
        
        [UFGroup("HoverHex")]
        [UnityEngine.SerializeField()]
        [UnityEngine.HideInInspector()]
        [UnityEngine.Serialization.FormerlySerializedAsAttribute("_HoverHexonlyWhenChanged")]
        protected bool _HoverHexOnlyWhenChanged;
        ...
        protected override void InitializeViewModel(uFrame.MVVM.ViewModel model) {
            ...
            playerui.HoverHex = this._HoverHex;
        }
        ...
        public override void Bind() {
            ...
            // Any designer bindings are created in the base implementation.
            if (_BindHoverHex) {
                this.BindProperty(this.Player.HoverHexProperty, this.HoverHexChanged, _HoverHexOnlyWhenChanged);
            }
        }
        
        public virtual void HoverHexChanged(Hex arg1) {
        }
        
        public virtual void ExecuteSetMousePosHoverHex(SetMousePosHoverHexCommand command) {
            command.Sender = Player;
            Player.SetMousePosHoverHex.OnNext(command);
        }
        
        public virtual void ExecuteSetMousePosHoverHex(Vector3 arg) {
            Player.SetMousePosHoverHex.OnNext(new SetMousePosHoverHexCommand() { Sender = Player, Argument = arg });
        }
    }
    ...
    public class PlayerViewBase : uFrame.MVVM.ViewBase {
        ...
        protected override void InitializeViewModel(uFrame.MVVM.ViewModel model) {
            ...
            playerview.HoverHex = this._HoverHex;
        }
    ...
    public class GameLogicUIViewBase : uFrame.MVVM.ViewBase {
        ...
        protected override void InitializeViewModel(uFrame.MVVM.ViewModel model) {
            ...
            // This method is invoked when applying the data from the inspector to the viewmodel.  Add any view-specific customizations here.
            var gamelogicuiview = ((GameLogicViewModel)model);
            gamelogicuiview.PlayerCount = this._PlayerCount;
        }
    ...
    public class GameLogicViewBase : uFrame.MVVM.ViewBase {
        ...
        protected override void InitializeViewModel(uFrame.MVVM.ViewModel model) {
            ...
            // var vm = model as GameLogicViewModel;
            // This method is invoked when applying the data from the inspector to the viewmodel.  Add any view-specific customizations here.
            var gamelogicview = ((GameLogicViewModel)model);
            gamelogicview.PlayerCount = this._PlayerCount;
        }
